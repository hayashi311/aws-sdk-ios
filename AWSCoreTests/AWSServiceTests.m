...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    ...
    [serviceManager setService:STS
                        forKey:@"AWSServiceTests.testServiceManager"];
    XCTAssertEqualObjects([serviceManager serviceForKey:@"AWSServiceTests.testServiceManager"], STS);
    [serviceManager removeServiceForKey:@"AWSServiceTests.testServiceManager"];
    XCTAssertNil([serviceManager serviceForKey:@"AWSServiceTests.testServiceManager"]);
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    AWSStaticCredentialsProvider *credentialsProvider = [[AWSStaticCredentialsProvider alloc] initWithAccessKey:nil
                                                                                                      secretKey:nil];
    AWSServiceConfiguration *serviceConfiguration = [AWSServiceConfiguration configurationWithRegion:AWSRegionUSWest2
